...
// Render state is not reset by default because they are many perfectly useful way of altering render state (e.g. changing m_shader/blending settings before an Image call).
