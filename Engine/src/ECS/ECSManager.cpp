...
namespace gns::core
{
	Entity ECSManager::CreateEntity(std::string name, std::shared_ptr<core::Scene> scene)
	{
	...
	Entity ECSManager::CreateEntity(std::shared_ptr<core::Scene> scene)
	{
		return CreateEntity("new entity", scene);
	}
	void ECSManager::Destroy(Entity& entity, std::shared_ptr<core::Scene> scene)
	{
